...
async function main() {
  ...
  const items = [
    ...
    { name: 'admin_audit_log >60d', desc: 'Admin action logs', table: 'admin_audit_log', where: `created_at < NOW() - INTERVAL '60 days'` },
    ...
    { name: 'forward_predictions >90d', desc: 'ML forward predictions', table: 'forward_predictions', where: `created_at < NOW() - INTERVAL '90 days'` },
    ...
    { name: 'signal_history >60d', desc: 'Generated trading signals', table: 'signal_history', where: `generated_at < NOW() - INTERVAL '60 days'` },
