...
const pool = new Pool(
  connectionString
    ? { connectionString, max: Number(process.env.DB_POOL_MAX || 25), connectionTimeoutMillis: Number(process.env.DB_POOL_TIMEOUT || 10000), idleTimeoutMillis: Number(process.env.DB_POOL_IDLE || 30000) }
    : {
