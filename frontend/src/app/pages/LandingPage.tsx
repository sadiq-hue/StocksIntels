...
const floatingShapes = [
  { size: 80, top: "8%", left: "3%", delay: 0, depth: 1, color: "rgba(13,116,144,0.06)", rotate: 15, border: "rgba(13,116,144,0.1)" },
  { size: 50, top: "18%", right: "5%", delay: 1.2, depth: 3, color: "rgba(14,165,233,0.05)", rotate: 40, border: "rgba(14,165,233,0.09)" },
  { size: 110, top: "50%", left: "1%", delay: 0.7, depth: 2, color: "rgba(13,116,144,0.04)", rotate: 60, border: "rgba(13,116,144,0.07)" },
  { size: 45, top: "70%", right: "3%", delay: 1.8, depth: 1, color: "rgba(14,165,233,0.06)", rotate: 25, border: "rgba(14,165,233,0.1)" },
  { size: 65, top: "35%", left: "12%", delay: 0.3, depth: 3, color: "rgba(13,116,144,0.05)", rotate: 80, border: "rgba(13,116,144,0.08)" },
  { size: 35, top: "82%", left: "18%", delay: 2.2, depth: 2, color: "rgba(14,165,233,0.06)", rotate: 10, border: "rgba(14,165,233,0.1)" },
  { size: 55, top: "12%", left: "45%", delay: 0.5, depth: 3, color: "rgba(13,116,144,0.04)", rotate: 120, border: "rgba(13,116,144,0.07)" },
  { size: 40, top: "42%", right: "15%", delay: 1.5, depth: 2, color: "rgba(14,165,233,0.05)", rotate: 70, border: "rgba(14,165,233,0.09)" },
  { size: 70, top: "60%", left: "30%", delay: 0.9, depth: 1, color: "rgba(13,116,144,0.04)", rotate: 35, border: "rgba(13,116,144,0.06)" },
  { size: 25, top: "28%", right: "22%", delay: 2.5, depth: 3, color: "rgba(14,165,233,0.07)", rotate: 90, border: "rgba(14,165,233,0.12)" },
];
...
const faqs = [
  ...
  { q: "Can I try before I pay?", a: "Yes. Every paid plan comes with a 7-day free trial. No credit card required. You also get a free plan with limited daily insights if you want to test the waters." },
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-[#0D7490]/20 relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0D7490]/2 via-transparent to-[#0EA5E9]/2" />
        ...
        <div className="absolute top-[-15%] right-[-5%] w-[1000px] h-[1000px] bg-gradient-to-bl from-[#0D7490]/6 via-[#0EA5E9]/3 to-transparent rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-[-15%] left-[-5%] w-[800px] h-[800px] bg-gradient-to-tr from-[#0EA5E9]/6 via-[#0D7490]/3 to-transparent rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "2s" }} />
      </div>
      ...
      <section ref={heroRef} className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-gradient-to-b from-white via-[#f2fafd] to-white">
        <div className="absolute inset-0">
          ...
          <StockChartBg />
          <div className="absolute top-[-20%] right-[-10%] w-[1000px] h-[1000px] bg-gradient-to-bl from-[#0D7490]/6 via-[#0EA5E9]/3 to-transparent rounded-full blur-3xl animate-pulse-slow" />
          <div className="absolute bottom-[-20%] left-[-10%] w-[800px] h-[800px] bg-gradient-to-tr from-[#0EA5E9]/6 via-[#0D7490]/3 to-transparent rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "2s" }} />
          {/* Grid overlay */}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 items-start">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:border-[#0D7490]/30 hover:shadow-xl hover:shadow-[#0D7490]/5 hover:-translate-y-1 transition-all duration-500"
              ...
              <div className="space-y-2">
                {["Delayed NSE data", "1 AI insight per day", "Basic watchlist"].map((f) => (
            ...
            <div className="bg-gray-900 text-white rounded-xl p-6 border border-gray-900 shadow-xl scale-[1.02] z-10 hover:shadow-2xl hover:shadow-[#0D7490]/10 transition-all duration-500"
              style={{ animation: `fade-in-up 0.5s ease-out 0.3s forwards`, opacity: 0 }}>
              <div className="mb-2">
      ...
      <section className="py-16 lg:py-20 bg-gradient-to-r from-[#0D7490] to-[#0A5F7A] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto leading-relaxed">
            No credit card required. Cancel anytime. Join other Kenyan traders using AI-powered market intelligence for NSE and global stocks.
          </p>
